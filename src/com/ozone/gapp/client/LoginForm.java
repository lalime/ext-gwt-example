...
import com.gwtext.client.widgets.form.VType;
    ...
    public class LoginForm implements EntryPoint {  
        ...
        public void onModuleLoad() {  
            ...
            //setup Combined Layout reader to process from submit response from server  
            ...
            Store store = new SimpleStore(new String[]{"abbr", "state"}, getStates());  
            store.load();  
            ...
            Viewport vp = new Viewport(panel);
            vp.doLayout();
        }  
